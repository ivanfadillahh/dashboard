...
<body style="padding-left:15px;padding-top:15px;">
    ...
    <form action="<?= base_url()?>Welcome/do_update_student" method="post">
        ...
        <button type="submit" style="background-color:#ff471a;border:2px solid #ff471a;border-radius:3px;padding:5px 15px;font-size:12px;color:#fff;cursor:pointer;">Update</button>
